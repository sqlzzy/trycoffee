    ...
    <section class="info-coffee">
        ...
        <div class="info-coffee__info-items">
            <span v-if="time" class="info-coffee__info-item info-coffee__info-item_type_time">
                <img src="../../assets/info-icons/icon-time.svg" alt="icon-time" loading="lazy" class="info-coffee__icon info-coffee__icon_type_time">
                {{ time }}
            </span>
            <span v-if="temperature" class="info-coffee__info-item info-coffee__info-item_type_temp">
                <img src="../../assets/info-icons/icon-temp.svg" alt="icon-temp" loading="lazy" class="info-coffee__icon info-coffee__icon_type_temp">
                {{ temperature }} °C
            </span>
            <span v-if="weight" class="info-coffee__info-item info-coffee__info-item_type_weight">
                <img src="../../assets/info-icons/icon-weight.svg" alt="icon-weight" loading="lazy" class="info-coffee__icon info-coffee__icon_type_weight">
                {{ weight }} г.
            </span>
            <span v-if="capacity" class="info-coffee__info-item info-coffee__info-item_type_capacity">
                <img src="../../assets/info-icons/icon-capacity.svg" alt="icon-capacity" loading="lazy" class="info-coffee__icon info-coffee__icon_type_capacity">
                {{ capacity }} мл
            </span>
            <span v-if="ice" class="info-coffee__info-item info-coffee__info-item_type_ice">
                <img src="../../assets/info-icons/icon-ice.svg" alt="icon-ice" loading="lazy" class="info-coffee__icon info-coffee__icon_type_ice">
                {{ ice }} г.
            </span>
        </div>
